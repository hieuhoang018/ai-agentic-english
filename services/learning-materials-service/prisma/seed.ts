...
async function main() {
  ...
  const assessmentDefs = [
    ...
    // Speaking A1
    { id: 'aq-s-a1-1', skill: 'speaking', cefrLevelTarget: 'A1', order: 1, prompt: { question: 'Which sentence is the best way to introduce yourself?', options: ['Hello, I am Lan. Nice to meet you.', 'Hello, I Lan nice.', 'I am meet Lan.', 'Nice Lan you.'] }, correctAnswer: { answer: 'Hello, I am Lan. Nice to meet you.' } },
    { id: 'aq-s-a1-2', skill: 'speaking', cefrLevelTarget: 'A1', order: 2, prompt: { question: 'How should you politely ask someone to repeat a question?', options: ['Can you repeat that, please?', 'Repeat that now.', 'You repeat?', 'What you say?'] }, correctAnswer: { answer: 'Can you repeat that, please?' } },
    { id: 'aq-s-a1-3', skill: 'speaking', cefrLevelTarget: 'A1', order: 3, prompt: { question: 'Choose the most natural response to “How are you?”', options: ['I am fine, thank you.', 'I fine thank.', 'How are fine?', 'Thank you are.'] }, correctAnswer: { answer: 'I am fine, thank you.' } },
    // Speaking A2
    { id: 'aq-s-a2-1', skill: 'speaking', cefrLevelTarget: 'A2', order: 4, prompt: { question: 'Which sentence is appropriate when ordering food at a restaurant?', options: ['I would like the chicken pasta, please.', 'Give chicken pasta.', 'I want chicken pasta now.', 'Chicken pasta you.'] }, correctAnswer: { answer: 'I would like the chicken pasta, please.' } },
    { id: 'aq-s-a2-2', skill: 'speaking', cefrLevelTarget: 'A2', order: 5, prompt: { question: 'Choose the best way to ask for directions to the station.', options: ['Could you tell me how to get to the station?', 'Where station go?', 'Station is where you?', 'Tell station now.'] }, correctAnswer: { answer: 'Could you tell me how to get to the station?' } },
    { id: 'aq-s-a2-3', skill: 'speaking', cefrLevelTarget: 'A2', order: 6, prompt: { question: 'How can you make an arrangement for tomorrow?', options: ['Are you free to meet tomorrow afternoon?', 'You meet tomorrow afternoon?', 'Tomorrow meet free?', 'Meet tomorrow you free.'] }, correctAnswer: { answer: 'Are you free to meet tomorrow afternoon?' } },
    // Speaking B1
    { id: 'aq-s-b1-1', skill: 'speaking', cefrLevelTarget: 'B1', order: 7, prompt: { question: 'Which phrase politely gives your opinion in a meeting?', options: ['In my opinion, we should review the timeline.', 'The timeline bad.', 'You must review timeline.', 'Timeline is my opinion.'] }, correctAnswer: { answer: 'In my opinion, we should review the timeline.' } },
    { id: 'aq-s-b1-2', skill: 'speaking', cefrLevelTarget: 'B1', order: 8, prompt: { question: 'Choose the clearest way to explain a delay to a colleague.', options: ['The report will be delayed because we are waiting for client feedback.', 'Report late because client.', 'Client feedback, report delay.', 'The report is waiting delay.'] }, correctAnswer: { answer: 'The report will be delayed because we are waiting for client feedback.' } },
    { id: 'aq-s-b1-3', skill: 'speaking', cefrLevelTarget: 'B1', order: 9, prompt: { question: 'How can you respectfully disagree during a discussion?', options: ['I see your point, but I think there may be another approach.', 'You are wrong about this.', 'That idea cannot work.', 'No, I disagree completely.'] }, correctAnswer: { answer: 'I see your point, but I think there may be another approach.' } },
  ];
