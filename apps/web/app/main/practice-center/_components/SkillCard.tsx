...
export default function SkillCard({ skill }: SkillCardProps) {
  ...
  return (
    <Link
      ...
      className="group rounded-lg border border-outline-variant/70 bg-surface-container-lowest p-6 shadow-[0_4px_18px_-8px_rgba(15,23,42,0.25)] transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_32px_-18px_rgba(15,23,42,0.45)]"
    >
