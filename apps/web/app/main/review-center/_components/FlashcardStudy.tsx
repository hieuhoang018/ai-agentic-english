    ...
    return (
      <div className="mx-auto max-w-3xl pt-28 text-center">
        <div className="rounded-lg border border-dashed border-outline-variant bg-white p-10">
          ...
          <h1 className="mt-4 text-2xl font-bold text-on-surface">No cards to study</h1>
    ...
    <div className="mx-auto max-w-4xl pt-6 sm:pt-16 lg:pt-28">
      ...
      >
        {!flipped ? (
          <>
            ...
            <p className="mt-20 text-on-surface-variant">Tap to flip</p>
          </>
        ) : (
          <>
      ...
      <div className="mt-8 flex items-center justify-center gap-3 sm:gap-6">
        <button
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full border border-outline-variant bg-white"
