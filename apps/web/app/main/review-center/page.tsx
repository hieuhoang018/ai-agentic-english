  ...
  return (
    <div>
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <ReviewFeatureCard href={flashcardsPath()} title="Ôn tập Flashcard" description="Luyện tập từ vựng với thẻ ghi nhớ thông minh" tag="Theo chủ đề" imageTone="bg-linear-to-br from-blue-50 to-blue-100 text-primary dark:text-primary-fixed-dim" icon="style" />
